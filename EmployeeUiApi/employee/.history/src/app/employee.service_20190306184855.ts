...
export class EmployeeService {
  ...
  //     `${this.employeesUrl}?name_like=${term}`
  //   );
  // }
  ...
  delete(id: number): Observable<Employee> {
    return this.http.delete<Employee>(this.employeesUrl + '/' + id, httpOptions);
  }

  /** PUT: update the employee on the server */
  put(employee: Employee): Observable<Employee> {
    return this.http.put<Employee>(this.employeesUrl  + '/' + employee.id, employee, httpOptions);
  }
}
